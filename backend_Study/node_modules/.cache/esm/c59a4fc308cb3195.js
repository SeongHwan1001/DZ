let Post,Joi,mongoose;_08c‍.x([["checkObjectId",()=>checkObjectId],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_08c‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_08c‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_08c‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);// // 컨트롤러 : 라우트 처리함수만 모아 놓은 파일
